...
public class Seller_requestCancel extends JFrame {
	...
	public Seller_requestCancel(String id) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
			        ...
			        while(scan.hasNextLine()){
			        	txt = scan.nextLine();
			          	txtarr = txt.split(" ");
			          	if(txtarr[0].equals(name)&&txtarr[1].equals(title)&&txtarr[2].equals(price)&&txtarr[3].equals("ø‰√ª")) {
			          		continue;
			          	}
			          	else {
			          		dump +=(txt+"\r\n");
