...
public class Customer_request extends JFrame {
	...
	public Customer_request(String id) {
				...
				try {
			        ...
			        while(scan.hasNextLine()){
			        	txt = scan.nextLine();
			          	...
			          	else if(txtarr[0].equals("admin")&&txtarr[1].equals(title)&&txtarr[2].equals(price)) {
			          		text = id + " " + txtarr[1] + " " + txtarr[2]+ " "+"±∏∏≈¡ﬂ";
			          		dump +=(text+"\r\n");
			          	}
			          	else {
			          		dump +=(txt+"\r\n");
